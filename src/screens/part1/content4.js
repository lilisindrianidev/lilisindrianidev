...
class part1_content4 extends Component{
  render(){
    return(
            ...
            <div  className='article_cover2_content1_container'>
              ...
              <div className='article_body'>
                <p className='article_body1'>
                  Two weeks ago we have published the biggest release in the history of Godot — 
                  <a href="" className='colora'> Godot 4.0 </a>
                  . It marked the beginning of a new journey for the engine and its users, like yourself. And as is the case with every new beginning, 
                  some problems have been reported, some points of frictions have been identified, and so fixes and improvements are in order.
                </p>
                <p className='article_body1'>
                  For the time being we are primarily focusing on changes that address critical issues (such as crashes and regressions), as well as small 
                  self-contained fixes to various parts of the engine and documentation improvements. This allows us to publish this patch release quickly and with a lot of confidence that it doesn’t introduce new problems and regressions in the process. As such, we are starting directly with a 
                  <a href="" className='colora'> Release Candidate</a>
                </p>
                <p className='article_body1'>
                  Please give it a try if you can. It should be safe to migrate your existing projects to 4.0.1, but to make sure of that 
                  we need your help testing the changes. If there are no significant regressions reported with release candidates, a stable version is going to be published soon. Don’t forget to always make backups when moving versions, 
